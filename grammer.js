...
// async function gg (){
//   let i = await client.getEntries({ content_type: "grammer"});
//   console.log(i.items[0].fields.grammerquiz);
// }
// gg();
// State Handler
...
// show next question
  ...
  async function beforeAnything() {
    let  q = await client.getEntries({ content_type: "grammer"});
    let p = await q.items[0].fields.grammerquiz;
